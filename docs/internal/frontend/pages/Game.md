...
| Drag card from hand → WordSlot              | Card is projected immediately; acknowledgements replace the authoritative base and replay newer pending moves. |
...
| Drag card from WordSlot → hand              | Card returns to hand immediately and remains projected over intermediate authoritative updates. |
