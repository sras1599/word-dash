...
- `waiting`: Lobby. Players join and the host selects settings. Player word boards are not initialized yet; the host can start when at least two players are present.
